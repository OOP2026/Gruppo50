...
public class Controller {
	...
	public void richiestaspostamentoLezione(Responsabile responsabile, String motivo, String giornoVecchio, int oraInizioVecchio, int minutoInizioVecchio, int oraFineVecchio, int minutoFineVecchio, String giornoNuovo,
		...
		docente.richiestaSpostamentoLezione(responsabile,motivo,giornoVecchio,oraInizioVecchio,minutoInizioVecchio,
				oraFineVecchio,minutoFineVecchio,giornoNuovo,oraInizioNuovo,minutoInizioNuovo,oraFineNuovo,minutoFineNuovo);
	}
